...
class Component extends DCLogic {
  ...
  renderVals(){
    ...
    if(rdi!=null){ const c=this.rosterRaw[rdi]; const fn=c.name.split(' ')[0];
      ...
      const rinfoBase=Object.assign({ville:'',phone:'',email:'',emailPro:'',address:'',siren:'',birth:'',instagram:'',tiktok:'',exclu:false,commission:'20%'}, this.rosterInfoRaw[rdi]||{}, (this.state.rosterInfo&&this.state.rosterInfo[rdi])||{});
