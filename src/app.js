...
class Component extends DCLogic {
  ...
  _cloudKeys(){ const local={deletedRoster:1,rosterEdited:1,photos:1,authed:1,authRole:1,space:1,creatorId:1,portalTab:1}; return this._persistKeys().filter(k=> !local[k]); }
  _persist(){
